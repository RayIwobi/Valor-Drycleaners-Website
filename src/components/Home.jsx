  ...
  return (
    <div>
        ...
        <div className='homewritep'>
            <h3>Welcome to Valor DryCleaners
            ...
            with cutting-edge cleaning methods and a customer-focused approach.
            ...
            garment care, alterations, and free pickup and delivery.
            ...
            gown, or a delicate designer piece, we treat every item as if it were our own.
